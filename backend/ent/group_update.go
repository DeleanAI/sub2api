...
func (_u *GroupUpdate) SetModelRateMultipliers(v jsontext.Value) *GroupUpdate {
	_u.mutation.SetModelRateMultipliers(v)
	return _u
}

// AppendModelRateMultipliers appends value to the "model_rate_multipliers" field.
func (_u *GroupUpdate) AppendModelRateMultipliers(v jsontext.Value) *GroupUpdate {
...
// SetModelRateMultipliers sets the "model_rate_multipliers" field.
func (_u *GroupUpdateOne) SetModelRateMultipliers(v jsontext.Value) *GroupUpdateOne {
	_u.mutation.SetModelRateMultipliers(v)
	return _u
}

// AppendModelRateMultipliers appends value to the "model_rate_multipliers" field.
func (_u *GroupUpdateOne) AppendModelRateMultipliers(v jsontext.Value) *GroupUpdateOne {
	_u.mutation.AppendModelRateMultipliers(v)
	return _u
}
