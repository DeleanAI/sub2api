...
func runSetupServer() {
	...
	if web.HasEmbeddedFrontend() {
		...
		frontend, err := web.ServeEmbeddedFrontend(r, overrideDir, config.GetFrontendVariant()) //nolint:staticcheck // SA4023: the !embed stub always errors; embed builds can return nil
		if err != nil {
