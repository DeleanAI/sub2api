...
func ProvideHandlers(
	...
	requestPayloadAudit *service.RequestPayloadAuditService,
	_ *service.IdempotencyCoordinator,
	_ *service.IdempotencyCleanupService,
	_ *service.OpenAIQuotaAutoResetService,
) *Handlers {
	usageHandler.SetRequestPayloadAuditService(requestPayloadAudit)
	adminHandlers.Usage.SetRequestPayloadAuditService(requestPayloadAudit)
	return &Handlers{
		Auth:                authHandler,
		User:                userHandler,
		APIKey:              apiKeyHandler,
		...
		Page:                pageHandler,
		RequestPayloadAudit: requestPayloadAudit,
	}
}
