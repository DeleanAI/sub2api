...
func TestIsPlatformPricingMatch(t *testing.T) {
	tests := []struct {
		...
		{"composite matches qwen pricing", PlatformComposite, PlatformQwen, true},
...
func TestMatchingPlatforms(t *testing.T) {
	tests := []struct {
		...
		{"composite returns concrete platforms", PlatformComposite, []string{PlatformAnthropic, PlatformGemini, PlatformOpenAI, PlatformAntigravity, PlatformGrok, PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformQwen, PlatformMiniMax, PlatformOpenCodeGo}},
	}
