...
func IsUpstreamBillingProbeIdentity(platform, accountType string) bool {
	...
	case PlatformOpenAI, PlatformAnthropic, PlatformGemini, PlatformAntigravity, PlatformGrok,
		PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformQwen, PlatformMiniMax, PlatformOpenCodeGo:
		return true
	default:
		return false
	}
...
// aliyuncs.com) serve the same role: official APIs that can never host
// /v1/sub2api/billing, so their accounts short-circuit to "unsupported"
// without a request.
