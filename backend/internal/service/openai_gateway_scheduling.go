...
// NormalizeOpenAICompatiblePlatform 保留 grok 与国产 OpenAI 兼容供应商的原值，
// 其他值一律归一为 openai。调度器据此对账号与请求做精确平台匹配：
...
func NormalizeOpenAICompatiblePlatform(platform string) string {
	switch platform {
	case PlatformGrok, PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformQwen, PlatformMiniMax, PlatformOpenCodeGo:
		return platform
	default:
