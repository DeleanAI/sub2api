...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		modelRateMultiplier       sql.NullFloat64
		billingType               int16
	...
	log := &service.UsageLog{
		...
		ModelRateMultiplier:       nullFloat64Ptr(modelRateMultiplier),
