...
export interface PublicSettings {
  ...
  /** 飞书登录开关，直接来自后端 feishu_connect.enabled（无后台开关） */
...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'qwen' | 'minimax' | 'opencode_go' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'qwen' | 'minimax' | 'opencode_go'
