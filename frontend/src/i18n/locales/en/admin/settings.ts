export default {
    settings: {
      ...
      customPages: {
        title: 'Custom Pages (Markdown)',
        description:
          'Markdown pages and their images are stored in the database, so every instance serves the same content. Link a page to the sidebar with a menu item whose URL is "md:<slug>".',
        limitsHint: 'Page content up to {page}, each asset up to {asset}, at most {count} assets per page.',
        pages: 'Pages',
        noPages: 'No pages yet. Create one with a slug below.',
        loadFailed: 'Failed to load custom pages',
        newSlug: 'New page slug',
        newSlugPlaceholder: 'e.g. help-center',
        create: 'Create page',
        refresh: 'Refresh',
        selectHint: 'Select a page on the left to edit it.',
        menuHint: 'Sidebar link: set a menu item URL to {url}',
        content: 'Markdown',
        contentPlaceholder: '# Title\n\nWrite Markdown here. Reference uploaded assets with ![alt](images/logo.png).',
        preview: 'Preview',
        ...
        deleteConfirmMessage: 'Delete page "{slug}" and all of its assets? Menu items pointing at it will show "page not found".',
        deleteSuccess: 'Page deleted',
        deleteFailed: 'Failed to delete page',
        assets: 'Assets',
        noAssets: 'No assets uploaded for this page.',
        assetPath: 'Path',
        assetPathPlaceholder: 'images/logo.png (defaults to the file name)',
        assetSize: 'Size',
        assetType: 'Type',
        assetUpdated: 'Updated',
        chooseFile: 'Choose file',
        upload: 'Upload',
        uploadSuccess: 'Asset uploaded',
        uploadFailed: 'Failed to upload asset',
        copyReference: 'Copy Markdown reference',
        deleteAsset: 'Delete asset',
        deleteAssetConfirmTitle: 'Delete asset',
        deleteAssetConfirmMessage: 'Delete asset "{path}"? Markdown referencing it will show a broken image.',
