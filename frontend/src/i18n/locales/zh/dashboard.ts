export default {
  ...
  usage: {
	...
	requestPayload: '请求详情',
	viewRequestPayload: '查看请求详情',
	method: '请求方法',
	requestPayloadUnavailable: '请求内容未被留存，或已因存储空间回收而移除。',
	payloadMetadata: '参数与元数据',
	requestBody: '请求输入',
	responseBody: '响应输出',
	storedSize: '存储大小',
	statusCode: '状态码',
	...
	responseBytes: '响应字节数',
	capturedAt: '捕获时间',
	conversationPreview: '文本对话预览',
	lastUserText: '最后一轮用户输入',
	modelOutput: '模型输出',
	emptyPayload: '（空）',
	loadPayloadFailed: '加载请求详情失败',
