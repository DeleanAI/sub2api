export default {
    settings: {
      ...
      customPages: {
        title: '自定义页面（Markdown）',
        description:
          'Markdown 页面及其图片保存在数据库中，所有实例返回相同内容。把菜单项的 URL 设为 "md:<slug>" 即可挂到侧边栏。',
        limitsHint: '页面正文最大 {page}，单个附件最大 {asset}，每页最多 {count} 个附件。',
        pages: '页面列表',
        noPages: '还没有页面，在下方输入 slug 创建一个。',
        loadFailed: '加载自定义页面失败',
        newSlug: '新页面 slug',
        newSlugPlaceholder: '如：help-center',
        create: '创建页面',
        refresh: '刷新',
        selectHint: '在左侧选择一个页面进行编辑。',
        menuHint: '侧边栏链接：把菜单项 URL 设为 {url}',
        content: 'Markdown 正文',
        contentPlaceholder: '# 标题\n\n在这里书写 Markdown，用 ![alt](images/logo.png) 引用已上传的附件。',
        preview: '预览',
        ...
        deleteConfirmMessage: '确定删除页面 "{slug}" 及其全部附件？指向它的菜单项将显示"页面不存在"。',
        deleteSuccess: '页面已删除',
        deleteFailed: '删除页面失败',
        assets: '附件',
        noAssets: '该页面还没有附件。',
        assetPath: '路径',
        assetPathPlaceholder: 'images/logo.png（默认使用文件名）',
        assetSize: '大小',
        assetType: '类型',
        assetUpdated: '更新时间',
        chooseFile: '选择文件',
        ...
        uploadSuccess: '附件已上传',
        uploadFailed: '上传附件失败',
        copyReference: '复制 Markdown 引用',
        deleteAsset: '删除附件',
        deleteAssetConfirmTitle: '删除附件',
        deleteAssetConfirmMessage: '确定删除附件 "{path}"？引用它的 Markdown 将显示为损坏的图片。',
        deleteAssetSuccess: '附件已删除',
        deleteAssetFailed: '删除附件失败',
        updatedAt: '更新时间',
