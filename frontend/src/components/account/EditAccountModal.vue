...
const cnProtocolOptions = computed<Array<{ value: CnApiProtocol; labelKey: string }>>(() => {
  ...
  if (normalizeCnProviderPlatform(props.account?.platform) === 'deepseek') {
    ...
    if (isCnProviderPlatform(newAccount.platform)) {
      ...
      editApiProtocol.value =
        ...
        storedProtocol === 'responses'
          ? storedProtocol
          : 'chat_completions'
      if (normalizeCnProviderPlatform(newAccount.platform) !== 'deepseek' && editApiProtocol.value === 'responses') {
